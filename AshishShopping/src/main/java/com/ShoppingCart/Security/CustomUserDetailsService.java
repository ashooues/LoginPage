...
public class CustomUserDetailsService implements UserDetailsService{
    ...
    public UserDetails loadUserByUsername(String ssoId)
        ...
        com.ShoppingCart.Model.UserDetails user = userService.findByEmail(ssoId);
    ...
    private List<GrantedAuthority> getGrantedAuthorities(com.ShoppingCart.Model.UserDetails user){
